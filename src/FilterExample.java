...
public class FilterExample {
    ...
    public Color aveOfNeighbors(Color[][] image, int row, int col, int neighborhoodSize){
        int numNeighbors=0;
        int red=0;
        int green=0;
        int blue=0;
        ...
        for(int r=row-neighborhoodSize; r<=row+neighborhoodSize; r++){
            for(int c=col-neighborhoodSize; c<=col+neighborhoodSize; c++){
                if( inBounds( image, r, r) ){
                    numNeighbors++;
